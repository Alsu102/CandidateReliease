...
public abstract class Product implements Item, Comparable<Product> {
  ...
  /**
   * This constructor sets the name of the product into local variables. Also, it sets a unique
   * serial number of the product, and increment the current production number for the next serial
   * number.
   *
   ...
   *
   * @return: the  Manufacturer name the serialNumber the date when the product was manufactured the
   * name of the product
   */
