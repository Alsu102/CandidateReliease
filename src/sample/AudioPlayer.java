 ...
 * Description  : This is a subclass of Product and implements the interface MultimediaControl.
...
public class AudioPlayer extends Product implements MultimediaControl {
  ...
  @Override
  public void play() {
    System.out.println("play");				//to emulate the item's play function
  }

  @Override
  public void stop() {
    System.out.println("stop");				//to emulate the item's stop function
  }
